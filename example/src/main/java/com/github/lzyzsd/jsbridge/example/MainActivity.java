...
public class MainActivity extends Activity implements OnClickListener {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebChromeClient(new BridgeWebChromeClient(webView) {
            ...
            @SuppressWarnings("unused") public void openFileChooser(ValueCallback<Uri> uploadMsg, String AcceptType) {
                this.openFileChooser(uploadMsg);
            }
        ...
        webView.setOnJsErrorListener(new BridgeWebView.OnErrorListener() {
            @Override public void onJsError() {
