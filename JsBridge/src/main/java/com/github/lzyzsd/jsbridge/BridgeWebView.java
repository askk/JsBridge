...
public class BridgeWebView extends SafeWebView implements WebViewJavascriptBridge {
    ...
    public void setOnJsErrorListener(OnErrorListener mOnJsErrorListener) {
        getBridgeChromeWebViewClient().setOnJsErrorListener(mOnJsErrorListener);
    }
    ...
    private void init() {
        ...
        this.setWebChromeClient(getBridgeChromeWebViewClient());
    }
    ...
    private BridgeWebChromeClient getBridgeChromeWebViewClient() {
        if (mBridgeWebChromeClient == null) {
    ...
    void handlerReturnData(String url) {
        ...
        if (f != null) {
            f.onCallBack(data);
            //responseCallbacks.remove(functionName); //延迟发送后，需要注释掉
            return;
        }
    }
